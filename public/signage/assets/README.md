...
- 確認: `wbgt-cube-okinawa-kumejima-demo.html` / `wbgt-cube-okinawa-kumejima-demo-bousai.html`
- 仕様: `docs/OKINAWA_KUMEJIMA_SIGNAGE_SPEC.md`

**熊本（地震・避難割り込み）**
- `wbgt-cube-kumamoto-4face.html` — 避難・地震シーン用（既定4面ではない）
- （アーカイブ）`wbgt-cube-osaka-suminoe-4face.html` — 旧4面
...
**防災テロップ確認**
- `../bousai-telop-demo.html` — 警戒レベル4種・その他気象・避難/熱中症/地震の文字テロップ切替デモ（512×128）
...
# → http://localhost:8765/wbgt-cube-okinawa-kumejima-demo.html  （沖縄確認メニュー）
# → http://localhost:8765/wbgt-cube-sasakikensetu-4face.html  （ECS）
# → http://localhost:8765/bousai-telop-demo.html              （防災テロップデモ）
```
